# geocodes addresses to address ranges on street segements
# and then counts how many are on each to create a linear density map
# this example uses 2million+ parking tickets issued in toronto in 2015
